...
class AuthorizationTest extends WebTestCase
{
    ...
    public function test_api_key_authentication_nothing(): void
    {
        ...
        $this->assertSame('Authorization method not supported. Use either Bearer token or a session.', $this->getJson()['message']);
    }
    ...
    public function test_wrong_authorization_header(): void
    {
        ...
        $this->assertResponseStatusCodeSame(403);
        $this->assertSame('Authorization header must start with "Bearer ".', $this->getJson()['message']);
    }
