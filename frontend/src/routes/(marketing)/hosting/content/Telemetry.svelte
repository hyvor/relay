<script>
    ...
    const payload = {
        ...
        queues_count: 'Number of queues configured',
        ...
        domains_active_count: 'Number of verified domains',
        ...
        recipients_24h_suppressed_count: 'Number of suppressed email recipients in the last 24 hours',

        // webhooks
        webhooks_24h_deliveries_count: 'Number of webhooks delivered in the last 24 hours'
    };
</script>
