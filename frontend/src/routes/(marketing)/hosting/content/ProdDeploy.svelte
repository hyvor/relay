...
<ul>
    ...
    <li>
        <code>PRIVATE_NETWORK</code> (optional): Set this if your servers are behind 1:1 NAT (e.g., a
        cloud VPC where each server has a private IP mapped to a public IP). See
